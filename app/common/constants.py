...
ETF_DEFAULT_SCREENER_COLUMNS = ["ticker", "kr_name", "en_name", "market"]
...
FACTOR_MAP_ETF_KR = {v: k for k, v in FACTOR_MAP.items() if k in ETF_FACTOR_KR_LIST}
...
FACTOR_MAP_ETF_US = {v: k for k, v in FACTOR_MAP.items() if k in ETF_FACTOR_US_LIST}
