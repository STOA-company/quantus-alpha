...
class NewsService:
    ...
    def _process_price_data(
        ...
        # 변동률 컬럼 확인
        change_column = "change_rt" if "change_rt" in df.columns else "change_1d"

        numeric_columns = ["that_time_price", "current_price", change_column]
        ...
        df["change_rate"] = df[change_column].round(2)
