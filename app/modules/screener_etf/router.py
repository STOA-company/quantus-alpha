...
from app.modules.screener.schemas import ColumnsResponse, FactorResponse, GroupFilter, GroupMetaData, MarketEnum
from app.modules.screener_etf.enum import ETFCategoryEnum
...
def get_factors(market: MarketEnum, screener_etf_service: ScreenerETFService = Depends(ScreenerETFService)):
...
# def get_filtered_etfs_description(filtered_etf: FilteredETF):
#     pass


# @router.post("/download", response_model=Dict)
# def download_filtered_etfs(filtered_etf: FilteredETF):
#     pass
...
def create_or_update_group(
    ...
    result = screener_etf_service.create_or_update_group(current_user=current_user, group_filter=group_filter)
