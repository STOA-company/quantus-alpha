...
async def get_financial_ratio(
    ...
    try:
        ...
        if lang == TranslateCountry.KO:
            company_name = stock_info.kr_name
        else:
            company_name = stock_info.en_name
        ...
        return BaseResponse[RatioResponse](
            ...
            data=RatioResponse(
                ...
                name=company_name,
                ctry=ctry_two,
                debt_ratios=debt_ratio_data,
                liquidity_ratios=liquidity_ratio_data,
                interest_coverage_ratios=interest_coverage_ratio_data
            ),
        )
